...
import com.lina.baselibs.view.wheelview.OnItemSelectedListener;
import com.lina.baselibs.view.wheelview.WheelView;
...
public class DatePicker extends Dialog implements View.OnClickListener{
    ...
    private int dayPos;
    private LayoutDatePickerBinding layoutAddressPickerBinding;
    public DatePicker(Context context) {
        super(context, R.style.transparentWindowStyle);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        layoutAddressPickerBinding = LayoutDatePickerBinding.inflate(inflater);
        initView();
        initData();
        setListener();

        this.setContentView(layoutAddressPickerBinding.getRoot());
    ...
    private void initView() {
        mYearWheelView = layoutAddressPickerBinding.wvYear;
        mMonthWheelView = layoutAddressPickerBinding.wvMonth;
        mDayWheelView = layoutAddressPickerBinding.wvDay;
        mTvConfirm = layoutAddressPickerBinding.tvConfirm;
        mTvCancel = layoutAddressPickerBinding.tvCancel;
        mTvLong = layoutAddressPickerBinding.tvLong;
    ...
    public void onClick(View v) {
        ...
        if(i == R.id.tv_long){
            if (mOnDateCListener != null) {
                mOnDateCListener.onDateSelectedLong();
            }
        }
        cancel();
    }
    ...
    public void settvLongVisible(int visible){
        mTvLong.setVisibility(visible);
    }
}
