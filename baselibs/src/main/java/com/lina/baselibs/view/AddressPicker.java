...
import com.lina.baselibs.databinding.LayoutAddressPickerBinding;
...
public class AddressPicker extends Dialog implements View.OnClickListener {
    ...
    private LayoutAddressPickerBinding layoutAddressPickerBinding;
    ...
    public AddressPicker(Context context) {
        ...
        layoutAddressPickerBinding = LayoutAddressPickerBinding.inflate(inflater);
        initCityData();
    ...
    private void initView() {
        mViewProvince = layoutAddressPickerBinding.wvProvince;
        mViewCity = layoutAddressPickerBinding.wvCity;
        mViewDistrict = layoutAddressPickerBinding.wvDistrict;
    ...
    private void initCityData() {
        try {
            String json = FileUtils.readText(context, "city.json");
