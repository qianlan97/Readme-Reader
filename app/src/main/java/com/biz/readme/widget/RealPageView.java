...
import com.biz.readme.entity.EpubData;
...
public class RealPageView extends PageView{
    ...
    private void init(Context context){
        ...
        Log.d(TAG, "init: "+screenWidth);
        Log.d(TAG, "init: "+screenHeight);
        a = new MyPoint();
        f = new MyPoint();
        g = new MyPoint();
        e = new MyPoint();
    ...
    public void updateBitmap() {
        if (mContentABitmap == null) {
            mContentABitmap = Bitmap.createBitmap(screenWidth,screenHeight, Bitmap.Config.RGB_565);
            mContentBBitmap = Bitmap.createBitmap(screenWidth,screenHeight, Bitmap.Config.RGB_565);
            mContentCBitmap = Bitmap.createBitmap(screenWidth,screenHeight,Bitmap.Config.RGB_565);
        }
